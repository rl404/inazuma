...
<a
	class="relative block w-full h-full bg-gradient-to-t from-red-200 to-white dark:from-red-900 dark:to-black"
	href="/manga"
>
	{#if loading}
	...
	{:else}
		<div class="grid gap-1 text-center">
			<div class="text-xs md:text-sm lg:text-base text-neutral-400">Manga</div>
