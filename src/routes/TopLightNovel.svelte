<script lang="ts">
	...
	onMount(() => {
		axios
			.get(`/api/manga?type=LIGHT_NOVEL&sort=-mean&limit=5`)
...
<div class="col-span-5 flex items-center justify-between">
	<div class="font-bold lg:text-xl">Top Light Novel</div>
	<a href={resolve(`/manga?type=LIGHT_NOVEL&sort=-mean`)} class="more-button">More</a>
</div>
