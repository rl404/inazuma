		...
		<div class="p-5 grid grid-cols-12 gap-1">
			...
			<div class="col-span-12 flex gap-1">
				<InputText
					...
					inputClass="bg-gradient-to-r from-white to-orange-200 dark:from-neutral-800 dark:to-orange-900"
				/>
			...
			<div class="col-span-12 grid grid-cols-5 gap-1">
				{#each data.slice(0, limit) as genre}
					<a
						class="border-2 border-black p-1 aspect-video flex items-center justify-center bg-gradient-to-r from-white to-orange-50 dark:from-neutral-800 dark:to-orange-950"
