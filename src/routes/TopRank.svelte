<script lang="ts">
	...
	onMount(() => {
		axios
			.get(`/api/manga?sort=-mean&limit=20`)
...
<div class="grid grid-cols-5 gap-1">
	<div class="col-span-5 flex items-center justify-between">
		<div class="md:text-lg lg:text-xl">Top Manga</div>
		<a href="/manga?sort=-mean" class="text-xs md:text-sm lg:text-base text-neutral-400">more</a>
	</div>
	{#if loading}
